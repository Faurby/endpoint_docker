...
func (c *timeServiceClient) GetTime(ctx context.Context, in *GetTimeRequest, opts ...grpc.CallOption) (*GetTimeReply, error) {
...
func (UnimplementedTimeServiceServer) GetTime(context.Context, *GetTimeRequest) (*GetTimeReply, error) {
